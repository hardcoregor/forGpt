...
contract GasThrottler {
    ...
    address public gasprice = address(0xA43509661141F254F54D9A326E8Ec851A0b95307); //TODO: CHANGE THIS
...
contract Strat is StratManager, FeeManager, GasThrottler {
    ...
    uint public yelRewards; // counting last rewards in yel //TODO: ADDED THIS
    bool public useUnderlying;
    bool public useMetapool;

    // Routes
    address[] public crvToNativeToYelRoute;
    ...
    constructor(
        ...
        address _gauge,
        address _pool,
        address[] memory _crvToNativeToYelRoute,
        address _vault,
        address _unirouter,
        address _keeper,
        address _feeConfig,
        address _yeller
    ) StratManager(_keeper, _unirouter, _vault, _feeConfig) public {
        want = _want;
        ...
        crv = _crvToNativeToYelRoute[0];
        native = _crvToNativeToYelRoute[1];
        yel = _crvToNativeToYelRoute[_crvToNativeToYelRoute.length - 1];
        crvToNativeToYelRoute = _crvToNativeToYelRoute;
        crvRouter = unirouter;
    ...
    function _harvest() internal {
        ...
        uint256 nativeBal = IERC20(native).balanceOf(address(this)); //TODO: WHY NATIVE?
    ...
    function swapRewardsToYel() internal {
        uint256 crvBal = IERC20(crv).balanceOf(address(this));
        IUniswapRouterETH(crvRouter).swapExactTokensForTokens(crvBal, 0, crvToNativeToYelRoute, address(this), block.timestamp);
    }
    ...
    function chargeFees() internal {
        ...
        uint256 ownerFeeAmount = yelBal * fees.owner / 1e18; //Same to mul yelBal to 0.1 = to get 10%
    ...
    function setCrvRoute(address _router, address[] memory _crvToNative) external onlyManager {
        ...
        _removeAllowances();
        crvToNativeToYelRoute = _crvToNative;
        crvRouter = _router;
        _giveAllowances();
    }
